...
public class CQMinimizer {
    ...
    public static void minimizeCQ(String inputFile, String outputFile) {
        ...
        try {
            ...
            buildAnswerHead(head, headVariables);
            ...
            removeDuplicateAndWriteIntoAnswer(copiedBody);            
            writeIntoOutputFile(answer.toString(), outputFile);
     ...
     */
    private static void writeIntoOutputFile(String myAnswer, String outputFile){
        try{
     ...
     */
    private static boolean checkMapping(HashMap<Object, Object> tempRelationMapping, List<RelationalAtom> originalAtomsList, List<RelationalAtom> copiedAtomsList){
     ...
     */
    private static void applyMap(List<RelationalAtom> applyTo, HashMap<Object, Object> tempRelationMapping){
     ...
     * @param copiedBody
     */
    private static void removeDuplicateAndWriteIntoAnswer(List<RelationalAtom> copiedBody){
     ...
     */
    private static boolean isSubset(List<RelationalAtom> leftList, List<RelationalAtom> rightList){
     ...
     * @param headVariables
     */
    private static void buildAnswerHead(Head head, HashSet<String> headVariables){
